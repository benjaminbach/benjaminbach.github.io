...
const Datepicker = class {
    ...
    render() {
        ...
        return (h(Host, { class: {
            ...
            } }, h("input", { type: "text", placeholder: this.placeholder, onFocus: this.hidePicker, value: this.getSelectedDate(), ref: (el) => this.dateInput = el }), h("button", { class: "toggle", onClick: this.togglePicker }, h("svg", { class: "icon-cal", viewBox: "0 0 19 17" }, h("path", { d: "M447.511,291.051v3.75h-3.75v-3.75h-6.5v3.75h-3.75v-3.75h-2.5V306.8h19v-15.75Zm1.25,14.5h-16.5v-8h16.5Zm-14-15.75h1.25v3.75h-1.25Zm10.25,0h1.25v3.75h-1.25Z", transform: "translate(-431.011 -289.801)" }))), this.error !== undefined && this.error.length > 0
