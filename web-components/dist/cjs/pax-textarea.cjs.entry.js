...
const Textarea = class {
    ...
    render() {
        return (core.h(core.Host, { "aria-disabled": this.disabled ? 'true' : null, class: {
            ...
            } }, core.h("textarea", { rows: this.rows, disabled: this.disabled, placeholder: this.placeholder, readOnly: this.readonly, value: this.value })));
    }
