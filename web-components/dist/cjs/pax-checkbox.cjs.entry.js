...
const Checkbox = class {
    ...
    render() {
        ...
        helpers.renderHiddenInput(true, this.el, this.name, (this.checked ? this.value : ''), this.disabled);
        return (core.h(core.Host, { onClick: this.handleClick, role: "checkbox", "aria-checked": `${this.checked}`, "aria-disabled": this.disabled ? 'true' : null, "aria-labelledby": labelId, class: {
                'in-item': helpers.hostContext('pax-item', this.el),
                'checkbox-checked': this.checked,
                'checkbox-disabled': this.disabled
            } }, core.h("svg", { class: "checkbox-icon", viewBox: "0 0 12.742 12.742" }, core.h("path", { d: "M0,0V16.02", transform: "translate(12.035 12.035) rotate(135)" }), core.h("path", { d: "M0,0V16.02", transform: "translate(12.035 0.707) rotate(45)" })), core.h("button", { type: "button", onFocus: this.handleFocus, onBlur: this.handleBlur, disabled: this.disabled, ref: element => this.buttonElement = element })));
    }
